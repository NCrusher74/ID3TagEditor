...
public class ID3ChapterFrame: ID3Frame, Equatable, CustomDebugStringConvertible {
    ...
    public var embeddedSubframes: [FrameName: ID3Frame]
     ...
     */
    public init(elementID: String, startTime: Int, endTime: Int, startByteOffset: Int, endByteOffset: Int, embeddedSubframes: [FrameName: ID3Frame]) {
